...
function buildBubbleHoleGeometryRecord({ geometry, holeNumber, updatedAt }) {
  ...
  return {
    ...
    route_json_text: stringifyJson(route || {}),
    tees_json: stringifyJson(teeRecords),
    tees_json_text: stringifyJson(teeRecords),
    bunkers_json: stringifyJson(bunkerRecords),
    bunkers_json_text: stringifyJson(bunkerRecords),
    water_json: stringifyJson(waterRecords),
    water_json_text: stringifyJson(waterRecords),
    hazards_json: stringifyJson(hazardRecords),
    hazards_json_text: stringifyJson(hazardRecords),
    fairway_json: stringifyJson(fairwayRecords),
    fairway_json_text: stringifyJson(fairwayRecords),
    green_json: stringifyJson(green || {}),
    green_json_text: stringifyJson(green || {}),
    geometry_status: geometryStatus,
    quality_notes_json: stringifyJson(notes),
    quality_notes_json_text: stringifyJson(notes),
