...
function buildBubbleHoleGeometryRecord({ geometry, holeNumber, updatedAt }) {
  ...
  return {
    ...
    nearest_bunkers: nearestBunkers,
    nearest_bunkers_json: stringifyJson(nearestBunkers),
    nearest_water_hazards: nearestWaterHazards,
    nearest_water_hazards_json: stringifyJson(nearestWaterHazards),
    greenside_bunkers: greensideBunkers,
    greenside_bunkers_json: stringifyJson(greensideBunkers),
    approach_relevant_hazards: approachRelevantHazards,
    approach_relevant_hazards_json: stringifyJson(approachRelevantHazards),
    strategic_summary: strategicSummary,
    strategic_summary_json: stringifyJson(strategicSummary),
